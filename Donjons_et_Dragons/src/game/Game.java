...
public class Game {
	...
	public static void main(String[] args) {
		...
		if(attributs.containsKey("type") && attributs.containsKey("nom") && attributs.get("type").equals(warrior)) {
		...
		} else if (attributs.containsKey("type") && attributs.containsKey("nom") && attributs.get("type").equals(magician)){
